...
require "cucumber_test_report_viewer/version"

Gem::Specification.new do |spec|
  spec.name          = "cucumber_test_report_viewer"
  spec.version       = CucumberTestReportViewer::VERSION
  ...
  spec.bindir        = "bin"
  spec.executables = ['cucumber_documentation_generate']
